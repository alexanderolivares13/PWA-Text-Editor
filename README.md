...
Navigate to: https://uofm-text-editor-5d5ef84ddce1.herokuapp.com/

- Click the install button on the top left of the screen and press install:

  ![Install-Prompt](/client/src/images/installation.png)

## Usage

- After installing the application you can start typing away, and any javascript keywords and values will be highlighted as you type:

![Application-Screenshot](/client/src/images/application.png)
